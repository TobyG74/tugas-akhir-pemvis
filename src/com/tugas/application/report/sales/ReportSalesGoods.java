 ...
 * @author tobis
 */
public class ReportSalesGoods extends javax.swing.JPanel {
    private DefaultTableModel tableModel;

    /**
     * Creates new form ReportIncomingGoods
     */
    public ReportSalesGoods() {
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tanggal Penjualan", "ID Pelanggan", "Total Harga"
            }
        ) {
...
//                JasperReport jasperReport = (JasperReport) JRLoader.loadObject(new File(report_file.getPath()));
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        AddReportSalesGoods add = new AddReportSalesGoods();
        add.setVisible(true);
