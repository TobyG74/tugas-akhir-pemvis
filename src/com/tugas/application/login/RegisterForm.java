...
import com.tugas.utils.PasswordStrengthStatus;
...
public class RegisterForm extends JPanel {
    ...
    private void init() {
        ...
        JLabel lbTitle = new JLabel("Selamat Datang di Pendaftaran!");
        JLabel description = new JLabel("Daftarkan Akunmu Untuk Mengakses Dashboard.");
